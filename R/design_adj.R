...
#' @param output The desired output, should be either "pvalue" or "matrix"
#'
#' @return result could be a vector of F-statistic p-values one for each row of dat or the adjustment matrix
#' 
#' @examples 
...
#' mod0 =  model.matrix(~1, data=pheno)
#' adjusted_pValues = design_adj(d,mod,mod0,treat = treat,batch = batch,output="pvalue")
#'
#'
#' @export
#' 

design_adj <- function(dat,mod,mod0,treat,batch,noise=NULL,output="pvalue"){
